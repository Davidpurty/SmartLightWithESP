 ...
 */
servoDriver::servoDriver(const uint8_t addr)
 ...
 */
bool servoDriver::begin(uint8_t prescale) {
  if (i2c_dev)
    delete i2c_dev;
 ...
 */
void servoDriver::setExtClk(uint8_t prescale) {
 ...
 */
void servoDriver::setOutputMode(bool totempole) {
 ...
 */
uint8_t servoDriver::readPrescale(void) {
 ...
 */
uint16_t servoDriver::getPWM(uint8_t num, bool off) {
 ...
 */
uint8_t servoDriver::setPWM(uint8_t num, uint16_t on,
                                        uint16_t off) {
#ifdef ENABLE_DEBUG_OUTPUT
 ...
 */
void servoDriver::writeMicroseconds(uint8_t num,
 ...
 * introspect)
 */
uint32_t servoDriver::getOscillatorFrequency(void) {
 ...
 */
void servoDriver::setOscillatorFrequency(uint32_t freq) {
